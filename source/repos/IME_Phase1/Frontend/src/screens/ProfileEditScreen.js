...
import {
  ...
  ActivityIndicator, Image, TouchableOpacity, Alert, StatusBar,
...
const styles = StyleSheet.create({
  ...
  photoSection: { alignItems: 'center', padding: 20, backgroundColor: '#1E3A5F', marginBottom: 12 },
  ...
  changePhotoText: { marginTop: 10, color: 'rgba(255,255,255,0.85)', fontSize: 14 },
