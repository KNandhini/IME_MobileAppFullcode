...
body: { padding: 20, paddingBottom: 40, },
    ...
    attachHint: { fontSize: 11, color: '#94A3B8', textAlign: 'left', marginTop: 6 },
    downloadBtn: {
      flexDirection: 'row',
...
export const AddCircularScreenStyles = (() => {
  ...
  return createScreenStyles({
    ...
    // ── Field wrapper (label + counter + hint/error) — used by the
    // shared Field/StyledInput components in AddCircularScreen ──
    field: {
      ...
      counterOver: { color: '#D9534F', fontWeight: '700' },
      hint: { fontSize: 11, color: '#94A3B8', marginTop: 4, marginLeft: 2 },
      error: { color: 'red', fontSize: 12, marginTop: 4, marginLeft: 2 },
    },

    // ── Styled input (focus + error states) ──
    styledInput: {
      base: {
...
export const GovernanceDetailsStyles = (() => {
  ...
  return createScreenStyles({
    ...
    // ── ADD THIS — was missing, causing the header gap mismatch ──
    header: {
       paddingTop: 48,
  paddingBottom: 24,
  paddingHorizontal: 16,
...
styledInput: {
  base: { backgroundColor: '#F8FAFC', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, color: '#1E293B', borderWidth: 1.5, borderColor: '#E2E8F0' },
  multiline: { height: 100, paddingTop: 12 },
  focused: { borderColor: COLORS.primary, backgroundColor: '#FFFFFF' },
  errored: { borderColor: '#D9534F' },
},
  });
})();
...
export const HealthNutritionDetailScreenStyles = (() => {
  const NAVY = COLORS.navy;
  const GOLD = COLORS.gold;
  const MEDIA_WIDTH = Dimensions.get('window').width - 40; // matches body padding (20 * 2)
...
export const HealthNutritionFormScreenStyles = StyleSheet.create({
  navbar: {
  ...
  fieldReq: { color: '#EF4444' },
  fieldHint: { fontSize: 11, color: '#94A3B8', marginTop: 5 },
  fieldError: { fontSize: 11, color: '#EF4444', marginTop: 5, fontWeight: '500' },
  ...
  inputFocused: { borderColor: '#1E3A5F', backgroundColor: '#fff' },
  inputErrored: { borderColor: '#EF4444', backgroundColor: '#FFF5F5' },
  ...
  statusPillActive: { backgroundColor: '#EEF9F0', borderColor: '#22C55E' },
  statusPillActiveInactive: { backgroundColor: '#FEF2F2', borderColor: '#EF4444' },
  statusPillText: { fontSize: 13, fontWeight: '600', color: '#64748B' },
  statusPillTextActive: { color: '#1E293B' },

  saveBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    backgroundColor: '#1E3A5F', borderRadius: 14, paddingVertical: 16, marginTop: 24,
  },
