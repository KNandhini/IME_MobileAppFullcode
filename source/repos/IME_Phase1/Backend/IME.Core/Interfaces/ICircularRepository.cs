...
public interface ICircularRepository
{
    ...
    Task UpdateCircularAsync(int circularId, string title, string? description, string? circularNumber, DateTime publishDate, int? clubId = null,string ? visibility = null);
