        ...
        <table width=""600"" cellpadding=""0"" cellspacing=""0""
          ...
          <tr>
            <td style=""background:#1E3A5F;padding:36px 40px;text-align:center;"">
              <p style=""margin:0 0 6px;color:rgba(255,255,255,0.7);font-size:13px;letter-spacing:2px;text-transform:uppercase;"">Institute of Municipal Engineers</p>
          ...
          <tr>
            <td style=""background:#1E3A5F;padding:20px 40px;text-align:center;"">
              ...
              <p style=""margin:0;color:rgba(255,255,255,0.4);font-size:11px;"">© {DateTime.Now.Year} Institute of Municipal Engineers. All rights reserved.</p>
            </td>
          </tr>
